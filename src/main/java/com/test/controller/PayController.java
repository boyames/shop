...
import com.test.util.AlipayConfig;
...
public class PayController {
	...
	*/
    ...
    public ModelAndView returnUrl(HttpServletRequest request) throws UnsupportedEncodingException, AlipayApiException {
        ...
        if(signVerified) {
            ...
            //修改订单状态
            orderService.updateOrderState(Integer.parseInt(out_trade_no));
            //查询订单信息(金额，收货信息)
            Address address=addressService.selectAddressByOrderId(Integer.parseInt(out_trade_no));
            //跳转到商城付款成功页面
